...
FLAIRS_BY_POSITION = {
    "-32px -16px": ("TagPro Developer", "dev"),
    "0px -16px": ("Community Contributor", "contributor"),
    "-16px -16px": ("Level 1 Donor ($10)", "level-1"),
    "-48px -16px": ("Level 2 Donor ($40)", "level-2"),
    "-64px -16px": ("Level 3 Donor ($100)", "level-3"),
    ...
    "-32px -32px": ("How Foolish", "foolish"),
    "-48px -32px": ("Hare Today, Goon Tomorrow", "hare"),
